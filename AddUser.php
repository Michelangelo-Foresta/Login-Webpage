  ...
  <?php 
    ...
    if( isset($_POST['nusername']) )
    {
        ...
        if(htmlentities($_POST['npassword'])!=htmlentities($_POST['nrepassword'])){
            ...
            if(mysqli_fetch_assoc(mysqli_query(getConn(),"Select username from users where username='$username'")))
                echo"<script>alert('username already taken! Please Try different username.')</script>";
            else{
                if(insertEntry($username, $password, $status, $country, $firstname, $lastname, $email, $children))
...
<div id="yaya">
    <a href="admin.php"><img src="Login.png" width="75" height="75"/></a>
</div>
<div id="alerts">
...
<h1 style="text-align:center">Add New User</h1>
    <div id="login">
        <form method="post" name="newuseradmin">
            <div id="first">
                <label for="username">Username: </label>
                <input type="text" placeholder="Enter Username" name="nusername" required>

                <label for="password">Password: </label>
                <input type="password" placeholder="Enter Password" name="npassword" id="passwordnew1" required><br>
                <label for="password">Re-Enter Password: </label>
                <input type="password" placeholder="Re-Enter Password" name="nrepassword" id="passwordnew" required><br>
            </div>

            <div id="second">
                <label>First name: </label>
                <input type="text" placeholder="Enter Firstname" name="nfirstname" required>

                <label>Last name: </label>
                <input type="text" placeholder="Enter Lastname" name="nlastname" required>

                <label>Email address: </label>
                <input type="text" placeholder="Enter Email" name="nemail" required><br>
            </div>

            <div id="third">
                <label>Country: </label>
                <select id="country" name="ncountry" required>
                ...
                <input type="text" placeholder="Enter Dependents" name="nchildren" required>
            </div>
            <div id="updatebutton">
                <button onclick="passwordAd()" id="update">Add User</button>
            </div>
        </form>
